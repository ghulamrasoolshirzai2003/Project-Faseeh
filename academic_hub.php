    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 768px) {
            ...
            .level-selector { gap: 10px; }
            .lvl-btn { padding: 10px 20px; font-size: 0.85rem; width: 100%; text-align: center; }
            .length-selector { flex-wrap: wrap; }
            .len-btn { flex: 1 1 calc(33.333% - 10px); text-align: center; padding: 10px 5px; }
...
<body>
    ...
    <div class="container">
        ...
        <div class="modes-grid">
            ...
            <!-- THE MAJLIS (New Immersive AI Mode) -->
            <div class="mode-card" style="background: linear-gradient(135deg, rgba(242, 153, 74, 0.2), rgba(48, 43, 99, 0.4)); border-color: var(--accent); grid-column: 1 / -1;">

                <div class="mode-icon">🕌</div>
                <div class="mode-title" style="font-size: 1.8rem;">The Majlis (AI Tutor)</div>
                <div class="mode-desc" style="font-size: 1.1rem; max-width: 600px;">Step into a virtual world. Practice real-time Arabic conversation with an AI tutor in different historical scenarios.</div>
                <a href="majlis.php" class="mode-btn" style="background: var(--accent); color: #333; padding: 12px 40px; font-size: 1.1rem; text-decoration: none;">Enter the Majlis</a>
            </div>
            <div class="mode-card">
                <div class="mode-icon">🌳</div>
            ...
            <div class="mode-card">
                ...
                <a href="sentence_builder.php" class="mode-btn" style="margin-top: auto; width: 100%; text-align: center; text-decoration: none;">Start Game</a>
            </div>

            <div class="mode-card">
                <div class="mode-icon">✍️</div>
                <div class="mode-title">Calligraphy Atelier</div>
                <div class="mode-desc">Trace and master Arabic letters with real-time AI stroke analysis and ghost mode.</div>
                <a href="writing_canvas.php" class="mode-btn" style="margin-top: auto; width: 100%; text-align: center; text-decoration: none;">Open Atelier</a>
            </div>
            ...
            <div class="mode-card">
                <div class="mode-icon">🎤</div>
                <div class="mode-title">Pronunciation Studio</div>
                <div class="mode-desc">Read Arabic out loud and get instant AI feedback on your pronunciation and accent.</div>
                <a href="speaking_practice.php" class="mode-btn" style="margin-top: auto; width: 100%; text-align: center; text-decoration: none;">Start Speaking</a>
            </div>
