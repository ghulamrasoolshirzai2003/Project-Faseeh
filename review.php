...
<body>
    ...
    <nav class="navbar">
        ...
        <a href="dashboard.php" style="color:white; text-decoration:none; font-weight:600; font-size:0.85rem;">✕ Done</a>
    </nav>
    ...
    function showEmpty(msg) {
        card.innerHTML = `
            <div class="empty-state">
                ...
                <a href="mcq.php" class="btn-primary" style="background: linear-gradient(to right, #a29bfe, #6c5ce7);">🧩 Quiz Mode</a>
            </div>
        `;
    }
