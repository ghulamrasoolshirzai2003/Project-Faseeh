...
$msg = "";
$google_error = isset($_GET['error']) && $_GET['error'] === 'google_failed' ? "❌ Google sign-in failed. Please try again." : "";
$initialView = "login"; 
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .forgot-link { display: block; text-align: right; margin-top: -8px; margin-bottom: 15px; font-size: 0.8rem; }
        .forgot-link a { color: var(--accent-gold); text-decoration: none; opacity: 0.8; transition: 0.3s; }
        .forgot-link a:hover { opacity: 1; text-decoration: underline; }

        .divider { display: flex; align-items: center; gap: 15px; margin: 20px 0; font-size: 0.8rem; opacity: 0.4; text-transform: uppercase; letter-spacing: 1px; color: white; }
        ...
        .btn-google {
            ...
            background: rgba(255,255,255,0.06); color: white; font-weight: 600; font-size: 0.95rem;
            cursor: pointer; transition: 0.3s; display: flex; align-items: center; justify-content: center; gap: 10px;
            text-decoration: none; font-family: 'Poppins', sans-serif;
        }
        .btn-google:hover { background: rgba(255,255,255,0.15); transform: translateY(-2px); }
...
<body>
    ...
    <div class="container">
        ...
        <?php if($google_error) echo "<div class='error-msg'>$google_error</div>"; ?>
