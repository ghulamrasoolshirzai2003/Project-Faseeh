...
<head>
    ...
    <style>
        :root { --bg-dark: #0f0c29; --bg-mid: #302b63; --bg-light: #24243e; --accent: #f2994a; --accent2: #f2c94c; --success: #2ecc71; --danger: #e74c3c; --info: #3498db; --glass: rgba(255, 255, 255, 0.05); --glass-border: rgba(255, 255, 255, 0.1); }
